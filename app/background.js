...
// 	if (state?.running) {
// 		if (!keepRunning) updateTabState(tabId, {running: false});
...
// 		const state = tabStore.get(details.tabId);
...
// 				updateTabState(tabId, {platform: response.payload});
...
// 					updateTabState(tabId, {running: true, payload: request.payload, sessionId, executionResult: 'pending'});
...
// 		// ------------------------------------------------------------
// 		case 'getTabState': {
// 			sendResponse(tabStore.get(tabId) || {
// 				running: false
// 			});
// 			return false;
// 		}
...
// 			console.log(`[BG] Current tab state:`, tabStore.get(tabId) || {})
// 			const newState = updateTabState(tabId, {...updates});
...
// 				const executionResult = newState?.executionResult ?? 'failed';
// 				/**
...
// 						APPLIED = "applied"
// 				*/
// 				let executionResultStatus
// 				console.log("[BBBBBBBBBBGGGGGGGGG] executionResult in tabStore:::", executionResult);
// 				if (['pending', 'job_expired', 'unsupported_platform', 'failed', 'applied'].includes(executionResult)) {
// 					executionResultStatus = executionResult;
// 				} 
// 				else if (executionResult === 'canceled') executionResultStatus = 'pending';
...
// 							body: JSON.stringify({ status: executionResultStatus })
// 						});
...
// 					}
// 				});
// 				console.log("[BG] 🏁 Execution Result Updated to DB:", executionResultStatus);
